                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?php echo CHtml::dropDownList("print_roles", "", Ticket::getPrintRoles(), array(
                                "class"=>"to-select2",
                                "empty"=>"------"
                            ));?>
                        </div>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?php echo CHtml::dropDownList("print_users", "", Ticket::getPrintAuthors(), array(
                                "class"=>"to-select2",
                                "empty"=>"------"
                            ));?>
                        </div>
                    ...
                    <div class="col-xs-4">
                        <div class="form-group">
                            ...
                            <?php
                            echo CHtml::dropDownList("city", "", City::getList(), array(
                                "class"=>"to-select2",
                                "multiple"=>"multiple"
                            ))
                            ?>
                    ...
                    <div class="col-xs-8">
                        <div class="form-group">
                            ...
                            <?php
                            $events = Event::getListEvents(array(Event::STATUS_ACTIVE, Event::STATUS_NO_ACTIVE));
                            echo CHtml::dropDownList("event_id", "", $events['data'], array(

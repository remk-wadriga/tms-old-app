 ...
 *
 * The followings are the available columns in table '{{type_place}}':
 * @property integer $id
 * @property string $name
 * @property integer $status
 */
class TypePlace extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'sectors' => array(self::HAS_MANY, 'Sector', 'type_place_id'),
		);
	}
	 ...
	 * @return TypePlace the static model class
	 */
	...
	/**
	 * @param $name String name of type Place
	 * @return int Integer id of type Place
	 */

...
(function () {
    ...
    SVG.extend(SVG.Element, {
        ...
        // The function can return a boolean or a object of the form {x, y}, to which the element will be moved. "False" skips generalMoving, true moves to raw x, y.
        draggable: function (constraint) {
            ...
            start = function (event) {
                ...
                element.startPosition = {
                    x: box.x, y: box.y, width: box.width, height: box.height, zoom: parent.viewbox().zoom, rotation: element.transform('rotation') * Math.PI / 180
                }
                if (window.editor.editorObj){
                    element.startPosition.x *= window.editor.editorObj.zoom;
                    element.startPosition.y *= window.editor.editorObj.zoom;
                }
                ...
                if (element.startEvent) {
                    ...
                    if (typeof constraint === 'function') {
                        ...
                        if (typeof coord === 'object') {
                            ...
                            if (window.editor.editorObj.zoom){
                                x /= window.editor.editorObj.zoom;
                                y /= window.editor.editorObj.zoom;
                            }
                            element.move(x, y)
                        }
            ...
            /* when dragging ends */
                ...
                /* calculate move position */
                var delta = {
                    x: event.pageX - element.startEvent.pageX, y: event.pageY - element.startEvent.pageY, zoom: element.startPosition.zoom
                }
